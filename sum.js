...
import { numDecimals, assert, RESULT_COLOR, ANNOTATION_COLOR, DECIMALS_SEPARATOR, GRID_SIZE } from './basic-algebra.js';
...
1352
 ...
 @returns {{ cells:Cell[], lines:Line[], viewBox:ViewBox }}
*/
export function sum(numbers) {
    for (let n of numbers) {
        // @ts-ignore
        assert(isFinite(n), 'must be a valid number');
        // @ts-ignore
